locals {
  this_access_group_name = "${join("", alicloud_nas_access_rule.this_access_rule.*.access_group_name)}"
  this_source_cidr_ip    = "${join("", alicloud_nas_access_rule.this_access_rule.*.source_cidr_ip)}"
  this_rw_access_type    = "${join("", alicloud_nas_access_rule.this_access_rule.*.rw_access_type)}"
  this_user_access_type  = "${join("", alicloud_nas_access_rule.this_access_rule.*.user_access_type)}"
